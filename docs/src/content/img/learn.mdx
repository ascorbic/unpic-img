...
The [`@unpic/placeholder`](/placeholder) package has lots of tools that can help
generate backgrounds, including tools to calculate the values yourself at build
time, or render blurhash placeholders using CSS.
...
preference - you need to change your actual device setting.
