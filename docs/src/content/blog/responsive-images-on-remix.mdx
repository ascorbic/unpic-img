...
up. This is just the place where Unpic shines. If you've not met it, Unpic is a
...
This is just using the default options. Take a look at the [the docs](/img/react) to
see what else is available, including different crop options, props for
full-width hero images and fixed-size images like logos.
